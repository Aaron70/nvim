...
-- Yank operations go to system clipboard; deletes/changes do NOT
vim.keymap.set({ "n", "x" }, "y", '"+y', { noremap = true, desc = "Yank to clipboard" })
vim.keymap.set("n", "Y", '"+Y', { noremap = true, desc = "Yank to end of line (clipboard)" })
